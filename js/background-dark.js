...
(function () {
    ...
    const fragment = `
        ...
        vec3 hueShiftRGB(vec3 col,float deg){
            ...
            float c2=cos(rad),s2=sin(rad);
            vec3 yiqS=vec3(yiq.x,yiq.y*c2-yiq.z*s2,yiq.y*s2+yiq.z*c2);
            return clamp(yiq2rgb*yiqS,0.0,1.0);
        }
    ...
    gl.uniform1f(uWarp,  0.4);
    applyTheme();

    // Watch for theme class changes on body
    const _themeObserver = new MutationObserver(applyTheme);
